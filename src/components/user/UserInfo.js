...
const UserInfo = () => {
  ...
  return (
    <div className="flex items-center justify-center space-x-3 bg-base-300 p-2 rounded-box shadow-lg md:w-50 lg:w-full">
      ...
      <div>
        <div className="font-bold xs:hidden lg:grid justify-items-center">{name}</div>
        <div className="text-sm opacity-50 text-center xs:hidden lg:grid justify-items-center">{username}</div>
      </div>
